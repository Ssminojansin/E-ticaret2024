<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/genel.Master" CodeBehind="kadin-parfumleri.aspx.vb" Inherits="eticaret.kadin_parfumleri" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" href="css/kadinparfum.css">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="prfhdr">
        <div class="containerr">
            ...
            <div class="card">
                <div class="image">
                    <img src="assets/images/ciceksiparfum.png">
                </div>
                <div class="info">
                    <div class="title">ÇİÇEKSİ KOKULAR</div>
                    <div class="description">
                        lorem ipsum dolor sit amer lorem ipsum dolor sit amer lorem ipsum dolor sit amer.
                    </div>
                </div>
    ...
    <section id="kdprf">
        <div class="page">
            ...
            <div class="main">
                <h1 class="tntprfbslk">KADIN PARFÜMLERİ</h1>
                <div class="filters">
                    <button class="btn btn-primary filtButon" style="display:none;" type="button">Filtrele</button>
